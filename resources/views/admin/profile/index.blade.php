                                                            ...
                                                            <div class="col">
                                                                            ...
                                                                            <select name="age" id="age" class="form-control {{ $errors->has('age') ? 'is-invalid' : '' }}">
                                                                                @if(isset($ages))
                                                                                    @foreach($ages as $id => $age)
                                                                                        <option value="{{$id}}" {{Auth::user()->age === $id ? 'selected':''}} >{{$age}}</option>
                                                                                    @endforeach
                                                                                @endif
                                                                            </select>
                                                                            @if($errors->has('age'))
                                                                ...
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="form-group">
                                                                            <label>County</label>
                                                                            <select name="county" id="county" class="form-control {{ $errors->has('county') ? 'is-invalid' : '' }}">
                                                                                @if(isset($counties))
                                                                                    @foreach($counties as $id => $county)
                                                                                        <option value="{{$id}}" {{Auth::user()->county === $id ? 'selected':''}}>{{$county}}</option>
                                                                                    @endforeach
                                                                                @endif
                                                                            </select>
