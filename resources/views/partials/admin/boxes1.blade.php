<div class="row m-t-25">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="overview-item overview-item--c2" data-href="{{route('admin.estimates.index')}}">
            <div class="overview__inner">
                <div class="overview-box clearfix">
                    <div class="row">
                        <h2 class="tex-2 align-items-center mx-auto pl-3 text-light">
                            {{count(\App\Quote::all()) ?? '0'}}
                        </h2>
                        <div class="icon ml-auto">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="overview-item overview-item--c3" data-href="{{route('admin.orders.index')}}">
            <div class="overview__inner">
                <div class="overview-box clearfix">
                    <div class="row">
                        <h2 class="tex-2 align-items-center mx-auto pl-3 text-light">
